...
<!--- - 🔭 I’m currently working on `data analysis` related to riverside communities monitored in respect to `generation and consumption of solar photovoltaic energy`; (as well) I am working on how to speed up the `optimization` process of `automated synthesis`. Besides the use of ESP8266 NodeMcu and Arduino in `IoT`
- 🌱 I’m currently exploring `machine learning` (ML) and data analysis with Weka and Orange tools; deep diving in optimization with `model checking`; and the use of IoT with `NodeMCU` or `Arduino`-->
...
- :new: 2025/2 Classes of Electrical Measurements and Instrumentation (FTE060) for undergraduate course in Electrical Engineering (status: started in August of 2025)
- :new: 2025/2 Classes of Electrical Safety Engineering (FTE065) for undergraduate course in Electrical Engineering (status: started in August of 2025)
- 2025/1 classes of Introduction to Electrical Engineering (FTE059) for undergraduate course in Electrical Engineering (status: finished in July of 2025)
- 2025/1 classes of Electromechanical Energy Conversion (FTE064) for undergraduate course in Electrical Engineering (status: finished in July of 2025)
- 2025/1 Laboratory of Energy Convertion (FTE052) for undergraduate course in Computer Engineering (status: finished in July of 2025)
...
- Rural Electrification (course offered asynchronously and continuously in portuguese, with no fixed start date). Moodle in https://ava.ufam.edu.br/ceteli/course/view.php?id=43 (2020, 2021 and 2022, with 3 different classes)
...
- 🆕 Ueda, C. B., Trindade, A. B., & Cordeiro, L. (Accepted/In press). Comparative Technical and Economic Performance of Four Inverter Architectures in Urban PV Microgeneration Systems. In IEEE PES ISGT Latin America 2025 IEEE. https://research.manchester.ac.uk/en/publications/comparative-technical-and-economic-performance-of-four-inverter-a/
- Queiroz, Laura; Trindade, Alessandro. "Aplicando Mineração de Dados e Aprendizagem de Máquina para Planejamento Energético de Comunidades Ribeirinhas — Estudo de Caso da Reserva do Tupé no Amazonas". X Simpósio Brasileiro de Sistemas Elétricos (SBSE). 2023. In https://drive.google.com/file/d/1jTs5efc4Q0QGkZbfjGRPcvtrw8SBCYQC/view?usp=sharing; Presentation slides in https://easychair.org/smart-slide/slide/BkWD
- Lima, Alice; Trindade, Alessandro. "Uso de energia solar fotovoltaica e de biodigestor na comunidade indígena Três Unidos: estudo de caso". X Simpósio Brasileiro de Sistemas Elétricos (SBSE). 2023. In https://drive.google.com/file/d/1vqcZTvSVb-IlZMCGwgGjwZ_8PXNOJ-m6/view?usp=sharing; Presentation slides in: https://easychair.org/smart-slide/slide/mPRZ
- Trindade, Alessandro; Simoes, Luis; Correa, Samuel. "Ciência de dados aplicada a questionários coletados de comunidade não eletrificadas do baixo Rio Negro no Amazonas". XIII Congresso Brasileiro de Planejamento Energético CBPE. (2022). In ANAIS DO XIII CONGRESSO BRASILEIRO DE PLANEJAMENTO ENERGÉTICO, ISBN: 978-65-992540-1-7. Sociedade Brasileira de Planejamento Energético (SBPE), Itajubá-MG. Paper in Portuguese: https://drive.google.com/file/d/124OtA94NSTI1fl266R6ko4XFHkrXxJSa/view?usp=sharing Poster in Portuguese: https://drive.google.com/file/d/1GRkPn4B55xkbyXWdN9ogpQQjm6ZJXuC5/view?usp=sharing. Anais in https://www.xiiicbpe.com.br/storage/anais/Anais_XIIICBPE.pdf
- Trindade, Alessandro; Figueiredo, Lucas; Franco, Georgia; Togniazzolo, Marco. Estudo de caso de aplicação de aprendizagem de máquina em dados coletados de comunidade ribeirinha atendida pelo Luz para Todos no Baixo Rio Negro, Amazonas". XIII Congresso Brasileiro de Planejamento Energético CBPE. (2022). In ANAIS DO XIII CONGRESSO BRASILEIRO DE PLANEJAMENTO ENERGÉTICO, ISBN: 978-65-992540-1-7. Sociedade Brasileira de Planejamento Energético (SBPE), Itajubá-MG. Paper in Portuguese: https://drive.google.com/file/d/1sOcJPvUeuV2meArw188tS1ny4xrJxlWX/view?usp=sharing Link of the presentation in Portuguese:  https://youtu.be/c7f9bfdwveQ. Anais in https://www.xiiicbpe.com.br/storage/anais/Anais_XIIICBPE.pdf
- Trindade, Alessandro, Nandor Verba, Nei Farias, Diego Ramon, Kojo Gyamfi, Helder da Silva, and Virgilio Viana. (2022). "Impact Evaluation of Solar Photovoltaic Electrification: Indigenous Community Case Study in Brazilian Amazon" Environmental Sciences Proceedings 15, no. 1: 16. https://doi.org/10.3390/environsciproc2022015016 
- (preprint) Trindade, Alessandro; Galvão, Edilson; Cordeiro, Lucas (2021): Multi-core synthesis and maximum satisfiability applied to optimal sizing of solar photovoltaic systems. TechRxiv. Preprint. https://doi.org/10.36227/techrxiv.14474235.v1
...
- S. T. Coelho, A. Sanches-Pereira, L. G. Tudeschini, J. Escobar, M. M. R. Poveda, N. M. E. Coluna, A. V. Colling, E. L. La Rovere, A. B. Trindade, O. L. Soliano Pereira. Biomass Residues as Electricity Generation Source in Low HD Source in Regions of Brazil. The XI Latin-American Congress of Electricity Generation and Transmission. CLAGTEE 2015. UNESP, São Paulo, 2015. Available in: https://gbio.webhostusp.sti.usp.br/sites/default/files/anexospaginas/1560168742_1.pdf
...
- :new: Researcher of the project 'Energy Use of Oilseed Plants in the Amazon Region: Value Generation and Regional Development (Green Diesel)' – Aneel R&D (ENEVA) - Coordinator: Prof. Patrícia Melchionna Albuquerque (UEA). UFAM Coordination: Prof. Eron Bezerra. Started in June 2025
...
-  updated overview at (https://docs.google.com/presentation/d/12bTq8h_DmQlOzAF5cPY0FUtzKhZXNYsUiF6V12l6PqM/edit?usp=sharing) in portuguese

## Innovation Institutional Scholarship Program for Technological Development and Innovation Initiation – PIBITI :bookmark:
- At Federal University of Amazonas (UFAM) https://edoc.ufam.edu.br/bitstream/123456789/8409/1/SEI_UFAM%20-%202036778%20-%20Edital-PIBITI-PROTEC.pdf - 11 months project (from October of 2024 to August of 2025)- title "Influência de grandezas físicas e químicas nas tecnologias de painéis solares fotovoltaicos e seu impacto na eficiência da geração de energia de sistemas distribuídos" - undergraduate physics student ISAILA DA SILVA DAMASCENO (isailadamasceno@icloud.com)
- 
...
- Bridges Network Conference - Speech topic "Report on energy projects in the heart of the Amazon: riverside communities and academia" - 3rd November 2025 - slides in https://drive.google.com/file/d/1-uq5I8EeUyvQNMhHfFYKXghKUNoTheLR/view?usp=sharing
